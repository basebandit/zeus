...
resource "helm_release" "argocd_image_updater" {
  ...
  version          = "0.12.3" # chart version - https://github.com/argoproj/argo-helm/blob/argocd-image-updater-0.12.3/charts/argocd-image-updater/Chart.yaml

  values = [file("${path.module}/../../charts/argocd/argocd-server/staging-argocd-image-updater-values.yaml")]
